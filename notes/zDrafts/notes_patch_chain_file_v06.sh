...
# After script changes to generate FWD and REV chain output:
  ...
  CrossMap.py bed test.Gm18.FWD.chain test.a1.Gm18.bed | grep -v Fail | grep -v split |     
    awk -v OFS="\t" '{print $1, $2, $7, $10, $4}' | sort -k5,5  > test.a1_to_a2.Gm18.CM_out_FWD

  join -a1 -1 5 -2 4 test.a1_to_a2.Gm18.CM_out_FWD test.Gm18.gbrowse.bed | 
    awk -v OFS="\t" 'NF==8 {print $7-$4, $1, $2, $3, $4, $5, $6, $7} NF==4 {print "XX", $4, $1, $2, $3}' \
  ...
  CrossMap.py bed test.Gm18.REV.chain test.a1.Gm18.bed | grep -v Fail | grep -v split |     
    awk -v OFS="\t" -v CHR=$chr_size '{print $1, $2, CHR-$7, $10, $4}' | 
    sort -k5,5 > test.a1_to_a2.Gm18.CM_out_REV

  join -a1 -1 5 -2 4 test.a1_to_a2.Gm18.CM_out_REV test.Gm18.gbrowse.bed | 
    awk -v OFS="\t" 'NF==8 {print $7-$4, $1, $2, $3, $4, $5, $6, $7} NF==4 {print "XX", $4, $1, $2, $3}' \
